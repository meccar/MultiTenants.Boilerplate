...
using BuildingBlocks.Application.Commands.ChangePassword;
using BuildingBlocks.Application.Commands.ConfirmEmail;
using BuildingBlocks.Application.Commands.CreateUserAccount;
using BuildingBlocks.Application.Commands.ForgotPassword;
using BuildingBlocks.Application.Commands.Login;
using BuildingBlocks.Application.Commands.Logout;
using BuildingBlocks.Application.Commands.ManageAccount;
using BuildingBlocks.Application.Commands.ResendEmailConfirmation;
using BuildingBlocks.Application.Commands.ResetPassword;
using BuildingBlocks.Application.Queries.GetCurrentUser;
using BuildingBlocks.Application.Queries.GetTwoFactorStatus;
