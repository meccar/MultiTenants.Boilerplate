...
namespace BuildingBlocks.Infrastructure.Persistance.Identity;
...
public sealed class IdentityService : IIdentityService
{
    ...
    public async Task<UserDto?> GetUserByIdAsync(string userId, CancellationToken cancellationToken = default)
    {
        ...
        return appUser == null ? null : MapToUserDto(appUser);
    }

    /// <inheritdoc />
    public async Task<UserDto?> GetUserByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<UserDto?> GetUserByUserNameOrEmailAsync(string userNameOrEmail, CancellationToken cancellationToken = default)
    {
