...
public interface IIdentityService
{
    ...
    /// </summary>
    Task<UserDto?> GetUserByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<UserDto?> GetUserByUserNameOrEmailAsync(string userNameOrEmail, CancellationToken cancellationToken = default);
